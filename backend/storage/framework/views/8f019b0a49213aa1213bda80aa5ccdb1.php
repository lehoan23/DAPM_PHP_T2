            ...
            <td style="padding: 40px; margin-top:40px;">
                ...
                <div style="border-radius: 5px; color: #000000; line-height: 1.6; background-color: #FFFFFF; border: 1px solid #f1f1f1; padding: 20px; box-shadow: 1px 1px 5px 1px #f1f1f1; margin-top: 20px; text-align: left; width: 100%;">
                    ...
                    <p>
                        ...
                        <a style="display: inline-block; cursor: pointer; padding: 7px 12px; background-color: #002559; color: #FFFFFF; font-size: 14px; font-weight: 500; text-decoration: none; border-radius: 3px; margin-top: 15px;" href="" target="_blank">verify</a>
                    </p>
                </div>
...
<?php /**PATH E:\PHP_CNM\DAPM_PHP_T2\backend\resources\views/mail/test-email.blade.php ENDPATH**/ ?>